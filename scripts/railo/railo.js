...
// src/engine.ts
var _templateObject140, _templateObject239, _templateObject326, _templateObject421, _templateObject518;
...
var chooseRider = function() {
  ...
  return _createClass13(CrimboEngine2, [{
    ...
    key: "createOutfit",
    value: function(task) {
      var outfit2 = _get2(_getPrototypeOf5(CrimboEngine2.prototype), "createOutfit", this).call(this, task);
      if (outfit2.equips.get($slot(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral15(["hat"])))) === $item(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral15(["Crown of Thrones"])))) {
        var choice = chooseRider();
        choice && (0, import_kolmafia25.enthroneFamiliar)(choice.familiar);
      } else if (outfit2.equips.get($slot(_templateObject326 || (_templateObject326 = _taggedTemplateLiteral15(["back"])))) === $item(_templateObject421 || (_templateObject421 = _taggedTemplateLiteral15(["Buddy Bjorn"])))) {
        var _choice = chooseRider();
        _choice && (0, import_kolmafia25.bjornifyFamiliar)(_choice.familiar);
      }
      return outfit2;
    }
  }, {
    ...
    key: "setChoices",
    value: function(task, manager) {
      _get2(_getPrototypeOf5(CrimboEngine2.prototype), "setChoices", this).call(this, task, manager), (0, import_kolmafia25.equippedAmount)($item(_templateObject518 || (_templateObject518 = _taggedTemplateLiteral15(["June cleaver"])))) > 0 && this.propertyManager.setChoices(Object.fromEntries(JuneCleaver_exports.choices.map(function(choice) {
...
var standardFamiliars = [{
  ...
  value: function() {
    return garboAverageValue.apply(void 0, _toConsumableArray14($items(_templateObject424 || (_templateObject424 = _taggedTemplateLiteral16(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6 + (1 / 3 + (have($effect(_templateObject519 || (_templateObject519 = _taggedTemplateLiteral16(["Jingle Jangle Jingle"])))) ? 0.1 : 0)) * ((0, import_kolmafia26.familiarWeight)($familiar(_templateObject618 || (_templateObject618 = _taggedTemplateLiteral16(["Stocking Mimic"])))) + (0, import_kolmafia26.weightAdjustment)());
  }
}, {
...
var _templateObject160, _templateObject251, _templateObject331, _templateObject426, _templateObject521, _templateObject620, _templateObject720, _templateObject820;
...
// src/familiar/freeFightFamiliar.ts
var _templateObject161, _templateObject260, _templateObject337, _templateObject427, _templateObject523, _templateObject621, _templateObject721;
...
function menu() {
  ...
  return canChooseMacro && sober() && (timeToMeatify() && familiarMenu.push({
    ...
    leprechaunMultiplier: 0,
    limit: "special"
  }), location2.zone === "Dinseylandfill" && have($familiar(_templateObject523 || (_templateObject523 = _taggedTemplateLiteral20(["Space Jellyfish"])))) && familiarMenu.push({
...
// src/macro.ts
var _templateObject170, _templateObject261, _templateObject338, _templateObject428, _templateObject524, _templateObject623, _templateObject723, _templateObject821, _templateObject919, _templateObject1018, _templateObject1115, _templateObject1213, _templateObject1313, _templateObject1413, _templateObject1513;
...
var Macro2 = /* @__PURE__ */ function(_StrictMacro) {
  ...
  return _createClass14(Macro3, [{
    ...
    key: "doItems",
    value: function() {
      var steps = new Macro3(), items = $items(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral21(["Rain-Doh blue balls, Time-Spinner, Rain-Doh indigo cup, HOA citation pad, porquoise-handled sixgun"]))).filter(function(i2) {
        return have(i2);
      });
      if (items.length)
        ...
        steps.tryHaveItem($item(_templateObject428 || (_templateObject428 = _taggedTemplateLiteral21(["seal tooth"]))));
      return this.step(steps);
    }
  }, {
    key: "standardCombat",
    value: function() {
      return this.externalIf(canOpenRedPresent() && (0, import_kolmafia29.myFamiliar)() === $familiar(_templateObject524 || (_templateObject524 = _taggedTemplateLiteral21(["Crimbo Shrub"]))), Macro3.trySkill($skill(_templateObject623 || (_templateObject623 = _taggedTemplateLiteral21(["Open a Big Red Present"]))))).externalIf(timeToMeatify() && (0, import_kolmafia29.myFamiliar)() === $familiar(_templateObject723 || (_templateObject723 = _taggedTemplateLiteral21(["Grey Goose"]))), Macro3.trySkill($skill(_templateObject821 || (_templateObject821 = _taggedTemplateLiteral21(["Meatify Matter"]))))).externalIf(get("cosmicBowlingBallReturnCombats") < 1, Macro3.trySkill($skill(_templateObject919 || (_templateObject919 = _taggedTemplateLiteral21(["Bowl Straight Up"]))))).externalIf(SongBoom_exports.song() === "Total Eclipse of Your Meat", Macro3.tryHaveSkill($skill(_templateObject1018 || (_templateObject1018 = _taggedTemplateLiteral21(["Sing Along"]))))).tryHaveSkill($skill(_templateObject1115 || (_templateObject1115 = _taggedTemplateLiteral21(["Extract"])))).tryHaveSkill($skill(_templateObject1213 || (_templateObject1213 = _taggedTemplateLiteral21(["Micrometeorite"])))).doItems().tryHaveSkill($skill(_templateObject1313 || (_templateObject1313 = _taggedTemplateLiteral21(["Nantlers"])))).tryHaveSkill($skill(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral21(["Nanoshock"])))).tryHaveSkill($skill(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral21(["Audioclasm"])))).attack().repeat();
    }
  }], [{
    key: "tryHaveSkill",
    value: function(skill) {
...
var _templateObject171, _templateObject270, _templateObject339, _templateObject429, _templateObject525, _templateObject624, _templateObject724, _templateObject823, _templateObject920, _templateObject1019, _templateObject1116, _templateObject1214, _templateObject1314, _templateObject1414, _templateObject1514, _templateObject1612, _templateObject1712, _templateObject1812, _templateObject1912, _templateObject2010, _templateObject2114, _templateObject2211, _templateObject2311, _templateObject2410, _templateObject2510, _templateObject2610, _templateObject2710, _templateObject289, _templateObject299, _templateObject309, _templateObject3112, _templateObject3210, _templateObject3310, _templateObject347;
...
function chooseQuestOutfit(_ref2) {
  ...
  }), ifHave("back", $item(_templateObject823 || (_templateObject823 = _taggedTemplateLiteral22(["Time Cloak"]))))), spec = mergeSpecs(ifHave("hat", $item(_templateObject920 || (_templateObject920 = _taggedTemplateLiteral22(["Crown of Thrones"])))), weapons, offhands, backs, {
    familiar: familiar3
  ...
  return !have($item(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral22(["Crown of Thrones"])))) && have($item(_templateObject1214 || (_templateObject1214 = _taggedTemplateLiteral22(["Buddy Bjorn"])))) && !("back" in mergedSpec) && (mergedSpec.back = $item(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral22(["Buddy Bjorn"])))), mergedSpec;
}
var equipmentFamiliars = /* @__PURE__ */ new Map([[$familiar(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral22(["Reagnimated Gnome"]))), $item(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral22(["gnomish housemaid's kgnee"])))], [$familiar(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral22(["Shorter-Order Cook"]))), $item(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral22(["blue plate"])))], [$familiar(_templateObject1812 || (_templateObject1812 = _taggedTemplateLiteral22(["Stocking Mimic"]))), $item(_templateObject1912 || (_templateObject1912 = _taggedTemplateLiteral22(["bag of many confections"])))]]);
function luckyGoldRing() {
  var dropValues = [100].concat(_toConsumableArray17([
    (0, import_kolmafia30.itemAmount)($item(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral22(["hobo nickel"])))) > 0 ? 100 : 0,
    (0, import_kolmafia30.itemAmount)($item(_templateObject2114 || (_templateObject2114 = _taggedTemplateLiteral22(["sand dollar"])))) > 0 ? garboValue($item(_templateObject2211 || (_templateObject2211 = _taggedTemplateLiteral22(["sand dollar"])))) : 0,
    (0, import_kolmafia30.itemAmount)($item(_templateObject2311 || (_templateObject2311 = _taggedTemplateLiteral22(["Freddy Kruegerand"])))) > 0 ? garboValue($item(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral22(["Freddy Kruegerand"])))) : 0,
    realmAvailable("sleaze") ? garboValue($item(_templateObject2510 || (_templateObject2510 = _taggedTemplateLiteral22(["Beach Buck"])))) : 0,
    realmAvailable("spooky") ? garboValue($item(_templateObject2610 || (_templateObject2610 = _taggedTemplateLiteral22(["Coinspiracy"])))) : 0,
    realmAvailable("stench") ? garboValue($item(_templateObject2710 || (_templateObject2710 = _taggedTemplateLiteral22(["FunFunds\u2122"])))) : 0,
    realmAvailable("hot") && !get("_luckyGoldRingVolcoino") ? garboValue($item(_templateObject289 || (_templateObject289 = _taggedTemplateLiteral22(["Volcoino"])))) : 0,
    realmAvailable("cold") ? garboValue($item(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral22(["Wal-Mart gift certificate"])))) : 0,
    realmAvailable("fantasy") ? garboValue($item(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral22(["Rubee\u2122"])))) : 0
  ].filter(function(value) {
    return value > 0;
  })));
  return sumNumbers(dropValues) / dropValues.length / 10;
}
var accessories = /* @__PURE__ */ new Map([[$item(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral22(["mafia thumb ring"]))), function(isFree) {
  return isFree ? 0 : (1 / 0.96 - 1) * get("valueOfAdventure");
}], [$item(_templateObject3210 || (_templateObject3210 = _taggedTemplateLiteral22(["lucky gold ring"]))), luckyGoldRing], [$item(_templateObject3310 || (_templateObject3310 = _taggedTemplateLiteral22(["Mr. Screege's spectacles"]))), function() {
  return 180;
}], [$item(_templateObject347 || (_templateObject347 = _taggedTemplateLiteral22(["Mr. Cheeng's spectacles"]))), function() {
  return 220;
}]]);
...
function cmcTarget() {
  return args.mode === "rose" ? {
    item: $item(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral24(["Extrovermectin\u2122"]))),
    environment: "i"
  } : {
    item: $item(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral24(["Breathitin\u2122"]))),
    environment: "u"
  };
}
var setup = {
  ...
  tasks: [{
    name: "Beaten Up",
    completed: function() {
      return !have($effect(_templateObject430 || (_templateObject430 = _taggedTemplateLiteral24(["Beaten Up"]))));
    },
    do: function() {
      if (["Poetic Justice", "Lost and Found"].includes(get("lastEncounter")) && uneffect($effect(_templateObject526 || (_templateObject526 = _taggedTemplateLiteral24(["Beaten Up"])))), have($effect(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral24(["Beaten Up"])))))
    ...
    do: function() {
      return (0, import_kolmafia31.useSkill)($skill(_templateObject921 || (_templateObject921 = _taggedTemplateLiteral24(["Disco Nap"]))));
    },
    sobriety: "either"
  }, {
    name: "Antidote",
    ...
    completed: function() {
      return (0, import_kolmafia31.myHp)() / (0, import_kolmafia31.myMaxhp)() >= 0.5;
    },
    do: function() {
      (0, import_kolmafia31.useSkill)($skill(_templateObject1117 || (_templateObject1117 = _taggedTemplateLiteral24(["Cannelloni Cocoon"]))));
    },
    sobriety: "either"
  }, {
    name: "Recover Failed",
    ...
    do: function() {
      (0, import_kolmafia31.visitUrl)("arena.php"), (0, import_kolmafia31.runChoice)(4);
    },
    outfit: {
    ...
    completed: function() {
      return (0, import_kolmafia31.itemAmount)($item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral24(["sand dollar"])))) === 0;
    },
    do: function() {
      return (0, import_kolmafia31.putCloset)((0, import_kolmafia31.itemAmount)($item(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral24(["sand dollar"])))), $item(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral24(["sand dollar"]))));
    },
    sobriety: "either"
  }, {
    name: "Closet Hobo Nickels",
    completed: function() {
      return (0, import_kolmafia31.itemAmount)($item(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral24(["hobo nickel"])))) === 0 || !have($familiar(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral24(["Hobo Monkey"])))) && !have($item(_templateObject2011 || (_templateObject2011 = _taggedTemplateLiteral24(["hobo nickel"]))), 1e3);
    },
    do: function() {
      return (0, import_kolmafia31.putCloset)((0, import_kolmafia31.itemAmount)($item(_templateObject2115 || (_templateObject2115 = _taggedTemplateLiteral24(["hobo nickel"])))), $item(_templateObject2212 || (_templateObject2212 = _taggedTemplateLiteral24(["hobo nickel"]))));
    },
    sobriety: "either"
  }, {
    name: "Snapper",
    ...
    completed: function() {
      return (0, import_kolmafia31.getWorkshed)() !== $item(_templateObject2611 || (_templateObject2611 = _taggedTemplateLiteral24(["cold medicine cabinet"]))) || (0, import_kolmafia31.totalTurnsPlayed)() < get("_nextColdMedicineConsult") || get("_coldMedicineConsults") >= 5 || countEnvironment(cmcTarget().environment) <= 10;
    },
    do: function() {
...
var _templateObject190, _templateObject281, _templateObject341, _templateObject431, _templateObject527, _templateObject626, _templateObject726, _templateObject825, _templateObject923, _templateObject1021, _templateObject1118, _templateObject1216, _templateObject1316, _templateObject1416, _templateObject1516, _templateObject1614, _templateObject1714, _templateObject1814, _templateObject1914, _templateObject2012, _templateObject2116, _templateObject2213;
...
var UnlockableZones = [{
  ...
  zone: "Wormwood",
  available: function() {
    return have($effect(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral25(["Absinthe-Minded"]))));
  },
...
function canAdventureOrUnlock(loc) {
  ...
  return !underwater(loc) && !skiplist.includes(loc) && ((0, import_kolmafia32.canAdventure)(loc) || canUnlock);
}
function unlock(loc, value) {
  var unlockableZone = UnlockableZones.find(function(z) {
    return z.zone === loc.zone;
  });
  return unlockableZone ? unlockableZone.available() ? !0 : (0, import_kolmafia32.buy)(1, unlockableZone.unlocker, value) === 0 ? !1 : (0, import_kolmafia32.use)(unlockableZone.unlocker) : (0, import_kolmafia32.canAdventure)(loc);
}
...
function wandererTurnsAvailableToday(location2) {
  ...
  }, digitize = canWanderCache.backup ? digitizedMonstersRemaining() : 0, yellowRay = canWanderCache["yellow ray"] ? Math.floor((0, import_kolmafia32.myAdventures)() / 100) : 0, wanderers = sum(WanderingSources, function(source) {
...
// src/wanderer/guzzlr.ts
var _templateObject191, _templateObject290, _templateObject348;
...
function considerAbandon(locationSkiplist) {
  ...
  (0, import_kolmafia33.print)("Got guzzlr quest ".concat(Guzzlr_exports.getTier(), " at ").concat(Guzzlr_exports.getLocation(), " with remaining turns ").concat(remaningTurns)), (!location2 || locationSkiplist.includes(location2) || !canAdventureOrUnlock(location2) || wandererTurnsAvailableToday(location2) < remaningTurns) && ((0, import_kolmafia33.print)("Abandoning..."), Guzzlr_exports.abandon());
}
    ...
    if (location2 !== null) {
      ...
      return [new WandererTarget("Guzzlr", location2, guzzlrValue(Guzzlr_exports.getTier()), function() {
        if (!guzzlrBooze)
          return !1;
        if (!have(guzzlrBooze)) {
          var fancy = guzzlrBooze && (0, import_kolmafia33.craftType)(guzzlrBooze).includes("fancy");
          guzzlrBooze && (!fancy || fancy && freeCrafts() > 0) ? (0, import_kolmafia33.retrieveItem)(guzzlrBooze) : guzzlrBooze && (0, import_kolmafia33.buy)(1, guzzlrBooze, guzzlrValue(Guzzlr_exports.getTier()));
        }
...
init_kolmafia_polyfill();
var _templateObject200, _templateObject291, _templateObject349, _templateObject434, _templateObject528, _templateObject627;
...
var LovebugTargets = [{
  ...
  element: "sleaze",
  location: $location(_templateObject349 || (_templateObject349 = _taggedTemplateLiteral27(["The Fun-Guy Mansion"]))),
  currency: $item(_templateObject434 || (_templateObject434 = _taggedTemplateLiteral27(["Beach Buck"])))
}, {
  element: "spooky",
  location: $location(_templateObject528 || (_templateObject528 = _taggedTemplateLiteral27(["The Deep Dark Jungle"]))),
...
function averageYrValue(location2) {
  var badAttributes = ["LUCKY", "ULTRARARE", "BOSS"], rates = (0, import_kolmafia34.appearanceRates)(location2), monsters = Object.keys((0, import_kolmafia34.getLocationMonsters)(location2)).map(function(m) {
  ...
  return monsters.length === 0 ? 0 : sum(monsters, function(m) {
    var items = (0, import_kolmafia34.itemDropsArray)(m).filter(function(drop) {
...
function yrValues() {
  var values2 = /* @__PURE__ */ new Map(), _iterator = _createForOfIteratorHelper14(import_kolmafia34.Location.all().filter(function(l) {
...
function yellowRayFactory(type, locationSkiplist) {
  if (type === "yellow ray") {
    var _ret = function() {
      var validLocations = import_kolmafia34.Location.all().filter(function(location2) {
      ...
      try {
        var _loop = function() {
          var unlockableZone = _step2.value, extraLocations = import_kolmafia34.Location.all().filter(function(l) {
...
// src/main.ts
var _templateObject201, _templateObject2100, _templateObject350, _templateObject435, _templateObject529, _templateObject628, _templateObject727, _templateObject826, _templateObject924, _templateObject1023, _templateObject1119, _templateObject1217, _templateObject1317, _templateObject1417, _templateObject1517, _templateObject1615, _templateObject1715, _templateObject1815, _templateObject1915, _templateObject2013, _templateObject2117, _templateObject2214, _templateObject2313, _templateObject2412, _templateObject2512, _templateObject2612, _templateObject2711, _templateObject2810, _templateObject2910;
...
function main(command) {
  ...
  var turncount = (0, import_kolmafia35.myTurncount)(), completed = args.turns > 0 ? function() {
    ...
    tasks: [{
      name: "June Cleaver",
      ready: function() {
        return have($item(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral28(["June cleaver"])))) && get("_juneCleaverFightsLeft") === 0;
      },
      do: (0, import_kolmafia35.myInebriety)() <= (0, import_kolmafia35.inebrietyLimit)() ? $location(_templateObject2100 || (_templateObject2100 = _taggedTemplateLiteral28(["Noob Cave"]))) : $location(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral28(["Drunken Stupor"]))),
      outfit: {
        weapon: $item(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral28(["June cleaver"])))
      },
      completed: function() {
      ...
      name: "Proton Ghost",
      ready: function() {
        return have($item(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral28(["protonic accelerator pack"])))) && get("questPAGhost") !== "unstarted" && !!get("ghostLocation");
      },
      do: function() {
        var location2 = get("ghostLocation");
        if (location2)
          (0, import_kolmafia35.adv1)(location2, 0, "");
        else
      ...
      outfit: function() {
        ...
        return chooseQuestOutfit({
          ...
          back: $item(_templateObject628 || (_templateObject628 = _taggedTemplateLiteral28(["protonic accelerator pack"]))),
          avoid: get("ghostLocation") === $location(_templateObject727 || (_templateObject727 = _taggedTemplateLiteral28(["The Icy Peak"]))) ? $items(_templateObject826 || (_templateObject826 = _taggedTemplateLiteral28(["Great Wolf's beastly trousers"]))) : []
        });
      },
      completed: function() {
      ...
      combat: new CrimboStrategy(function() {
        return Macro2.trySkill($skill(_templateObject924 || (_templateObject924 = _taggedTemplateLiteral28(["Sing Along"])))).trySkill($skill(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral28(["Shoot Ghost"])))).trySkill($skill(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral28(["Shoot Ghost"])))).trySkill($skill(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral28(["Shoot Ghost"])))).trySkill($skill(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral28(["Trap Ghost"]))));
      }),
      sobriety: "sober"
    }, {
      name: "Vote Wanderer",
      ready: function() {
        return have($item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral28(['"I Voted!" sticker'])))) && (0, import_kolmafia35.totalTurnsPlayed)() % 11 === 1 && get("lastVoteMonsterTurn") < (0, import_kolmafia35.totalTurnsPlayed)() && get("_voteFreeFights") < 3;
      },
      do: function() {
        (0, import_kolmafia35.adv1)(wanderWhere("wanderer"), -1, "");
      },
      outfit: function() {
        return chooseQuestOutfit({
          ...
          acc3: $item(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral28(['"I Voted!" sticker'])))
        });
      },
      completed: function() {
      ...
      do: function() {
        (0, import_kolmafia35.adv1)(wanderWhere("wanderer"), -1, ""), digitizes = get("_sourceTerminalDigitizeMonsterCount");
      },
      combat: new CrimboStrategy(function() {
        return Macro2.redigitize().standardCombat();
      }),
      ...
      name: "Void Monster",
      ready: function() {
        return have($item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral28(["cursed magnifying glass"])))) && get("cursedMagnifyingGlassCount") === 13;
      },
      completed: function() {
      ...
      outfit: function() {
        return chooseQuestOutfit({
          ...
          offhand: $item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral28(["cursed magnifying glass"])))
        });
      },
      do: function() {
        return (0, import_kolmafia35.adv1)(wanderWhere("wanderer"), -1, "");
      },
      sobriety: "sober",
      combat: new CrimboStrategy(function() {
        return Macro2.standardCombat();
      ...
      completed: function() {
        return have($effect(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral28(["Everything Looks Yellow"]))));
      },
      ready: function() {
        return have($item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral28(["Jurassic Parka"])))) && have($skill(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral28(["Torso Awareness"]))));
      },
      outfit: function() {
        return chooseQuestOutfit({
          location: wanderWhere("yellow ray"),
          isFree: !0
        }, {
          shirt: $item(_templateObject2117 || (_templateObject2117 = _taggedTemplateLiteral28(["Jurassic Parka"])))
        });
      },
      prepare: function() {
      ...
      do: function() {
        return (0, import_kolmafia35.adv1)(wanderWhere("yellow ray"), -1, "");
      },
      combat: new CrimboStrategy(function() {
        var romance = get("romanticTarget"), freeMonsters = $monsters(_templateObject2214 || (_templateObject2214 = _taggedTemplateLiteral28(["sausage goblin"])));
        return romance != null && romance.attributes.includes("FREE") && freeMonsters.push(romance), Macro2.if_(freeMonsters, Macro2.standardCombat()).skill($skill(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral28(["Spit jurassic acid"])))).abort();
      }),
      sobriety: "sober"
    }, {
      name: "Grey You Attack Skill",
      completed: function() {
        return have($skill(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral28(["Nantlers"])))) || have($skill(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral28(["Nanoshock"])))) || have($skill(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral28(["Audioclasm"]))));
      },
      do: $location(_templateObject2711 || (_templateObject2711 = _taggedTemplateLiteral28(["The Haunted Storage Room"]))),
      ready: function() {
        return (0, import_kolmafia35.myClass)() === $class(_templateObject2810 || (_templateObject2810 = _taggedTemplateLiteral28(["Grey Goo"]))) && (0, import_kolmafia35.canAdventure)($location(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral28(["The Haunted Storage Room"]))));
      },
      combat: new CrimboStrategy(function() {
        return Macro2.standardCombat();
      }),
